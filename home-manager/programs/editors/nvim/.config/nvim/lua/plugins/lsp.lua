...
local markdown_oxide_config = function(capabilities)
	return {
...
local setup_servers_non_nixos = function()
	...
	local servers = {
		...
		-- r_language_server = {},
		markdown_oxide = markdown_oxide_config(capabilities),
...
local setup_servers_nixos = function()
	...
	require("lspconfig").markdown_oxide.setup(markdown_oxide_config(capabilities))
