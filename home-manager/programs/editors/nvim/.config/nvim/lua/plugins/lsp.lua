...
local setup_lsp_common = function()
  vim.api.nvim_create_autocmd("LspAttach", {
    ...
    callback = function(event)
      ...
      map("<leader>k", function() vim.lsp.buf.signature_help() end, 'toggle signature', 'n')
      map("<C-k>", function() require('lsp_signature').toggle_float_win() end, 'toggle signature', 'n')
      map("<C-k>", function() require('lsp_signature').toggle_float_win() end, 'toggle signature', 'i')
